export const projects = [
  {
    ...
    technologies: ['Flutter', 'Dart', 'Firebase','Android studio','Supabase'],
    githubUrl: 'https://github.com/Rohanmon80/EduMate',
    liveUrl: null,
    featured: true,
    size: 'large',
...

  {
    ...
    githubUrl: 'https://github.com/Rohanmon80/AgreeWise',
    liveUrl: null,
    featured: false,
    size: 'medium',
...

  {
    ...
    githubUrl: 'https://github.com/Rohanmon80/interviewX',
    liveUrl: null,
    featured: false,
    size: 'small',
...

  {
    ...
    category: 'AI / ML',
    shortDesc:
      'An AI/ML-based health-risk prediction model that won 1st Prize at the Hackathon.',
    description:
    ...
    technologies: ['JavaScript', 'CSS', 'Data Science'],
    achievement: '1st Prize — Hackathon',
    githubUrl: 'https://github.com/Rohanmon80/Healthcare_Assistant',
    liveUrl: null,
    featured: false,
    size: 'small',
...

  {
    ...
    githubUrl: 'https://github.com/Rohanmon80/Jarvis-AI-Voice-Assistant',
    liveUrl: null,
    featured: false,
    size: 'small',
